...
module NameNanny
  RESERVED_NAMES = (IO.readlines "#{Rails.root}/vendor/plugins/name_nanny/lib/reserved_words.txt").each { |w| w.chop! }.freeze
  BAD_WORDS      = (IO.readlines "#{Rails.root}/vendor/plugins/name_nanny/lib/bad_words.txt").each { |w| w.chop! }.freeze
